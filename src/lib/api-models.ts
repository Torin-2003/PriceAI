...
export const apiProviderCandidates = [
  {
    ...
    sourceLabel: "火山引擎方舟官网",
    reason: "用户明确关心的国产模型套餐候选，官网入口可公开访问，但套餐价格和限制需要从官方文档或活动页核验。",
    nextStep: "补火山方舟官方价格/套餐页解析器，确认是否存在面向编码工具的 Coding Plan，再决定是否转入正式报价。",
    notes: "候选阶段不进入前台报价。",
    updatedAt: apiModelUpdatedAt,
  },
  {
    id: "tencent-hunyuan-coding-plan",
    name: "腾讯云混元 / Coding Plan 候选",
    type: "subscription",
    billingMode: "订阅套餐",
    ...
    sourceLabel: "腾讯云混元官网",
    reason: "已有社区线索提到腾讯云 Coding Plan / TokenHub，但需要回到腾讯云官方页面确认价格、额度和模型覆盖。",
    nextStep: "查找腾讯云官方套餐或价格页；若只能找到第三方线索，继续留在候选池，不进入正式报价。",
    notes: "优先确认是否有公开价格表、RPM/TPM 或请求窗口。",
    updatedAt: apiModelUpdatedAt,
  },
  {
    id: "jdcloud-joyai",

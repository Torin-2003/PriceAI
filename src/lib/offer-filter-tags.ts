...
export const OFFER_FILTER_TAGS: OfferFilterTagDefinition[] = [
  ...
  },
  {
    ...
    label: "巴西 Pix",
    group: "plusChannel",
    description: "ChatGPT Plus 日抛 / 成品号分类里的巴西 Pix 渠道报价。",
  },
  {
    id: "chatgpt_plus_netherlands_ideal",
    label: "荷兰 iDEAL",
    group: "plusChannel",
    description: "ChatGPT Plus 日抛 / 成品号分类里的荷兰 iDEAL 渠道报价。",
  },
  {
    id: "chatgpt_plus_india_upi",
    label: "印度 UPI",
    group: "plusChannel",
    description: "ChatGPT Plus 日抛 / 成品号分类里的印度 UPI 渠道报价。",
  },
  {
    id: "chatgpt_plus_europe_channel",
    label: "欧洲渠道",
    group: "plusChannel",
    description: "ChatGPT Plus 日抛 / 成品号分类里的欧洲、欧区或 AT 未接码渠道报价。",
  },
  {
